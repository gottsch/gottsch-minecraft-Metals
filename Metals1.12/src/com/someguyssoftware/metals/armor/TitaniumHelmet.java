...
public class TitaniumHelmet extends ItemArmor {
	...
	public final static String NAME = "titanium_helmet";
	 ...
	 */
	public TitaniumHelmet(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.titaniumHelmetId);
	}
