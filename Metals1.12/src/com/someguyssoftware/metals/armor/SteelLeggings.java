...
public class SteelLeggings extends ItemArmor {
	...
	public final static String NAME = "steel_leggings";
	 ...
	 */
	public SteelLeggings(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.steelLeggingsId);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public String getArmorTexture(ItemStack itemStack, Entity entity, EntityEquipmentSlot slot, String type) {
		return Metals.MODID + ":textures/models/armor/steel_layer_2.png";
	}
