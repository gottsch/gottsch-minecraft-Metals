 ...
 */
@Deprecated
public class TitaniumBoots extends ItemArmor {
	
	public final static String NAME = "titanium_boots";
	 ...
	 */
	public TitaniumBoots(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.titaniumBootsId);
	}
