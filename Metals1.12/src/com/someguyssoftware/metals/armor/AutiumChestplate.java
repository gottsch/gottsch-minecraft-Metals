 ...
 *
 */
public class AutiumChestplate extends ItemArmor {
	
	public final static String NAME = "autium_chestplate";
	 ...
	 */
	public AutiumChestplate(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.autiumChestplateId);
	}
