 ...
 *
 */
public class AutiumHelmet extends ItemArmor {
	
	public final static String NAME = "autium_helmet";
	 ...
	 */
	public AutiumHelmet(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.autiumHelmetId);
	}
