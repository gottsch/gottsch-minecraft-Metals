...
public class SteelBoots extends ItemArmor {
	...
	public final static String NAME = "steel_boots";
	 ...
	 */
	public SteelBoots(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.steelBootsId);
	}
