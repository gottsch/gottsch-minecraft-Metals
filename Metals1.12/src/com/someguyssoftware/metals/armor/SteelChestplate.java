...
public class SteelChestplate extends ItemArmor {
	...
	public final static String NAME = "steel_chestplate";
	 ...
	 */
	public SteelChestplate(ArmorMaterial material, int renderIndex, EntityEquipmentSlot armourType) {
		super(material, renderIndex, armourType);
		this.setUnlocalizedName(NAME);
		this.setCreativeTab(Metals.METALS_TAB);
		setRegistryName(MetalsConfig.steelChestplateId);
	}
