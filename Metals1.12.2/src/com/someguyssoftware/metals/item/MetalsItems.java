...
public class MetalsItems {
	...
	static {		
		 ...
		 */
		STEEL_AXE = new SteelAxe(Metals.MODID, MetalsConfig.steelAxeId, STEEL_TOOL_MATERIAL, MetalsItems.STEEL_INGOT);
		TITANIUM_AXE = new TitaniumAxe(Metals.MODID, MetalsConfig.titaniumAxeId, TITANIUM_TOOL_MATERIAL, MetalsItems.TITANIUM_INGOT);
		AUTIUM_AXE = new AutiumAxe(Metals.MODID, MetalsConfig.autiumAxeId, AUTIUM_TOOL_MATERIAL, MetalsItems.AUTIUM_INGOT);
